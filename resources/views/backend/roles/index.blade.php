    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            ...
            <div class="page-title-actions">
                <a href="{{ Route('app.roles.create') }}" type="button" data-toggle="tooltip" title="create role" data-placement="bottom"
                        ...
                        @foreach($roles as $key => $role)
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    @else
                                        <span class="badge badge-danger">no permissions found :(</span>
                                    @endif
                                </td>
